...
export const offers=[
    {
        ...
        img:smsicon,
        title:"SMS API",
        content:"Send bulk SMS to boost customer interaction. Integrate SMS API into your applications for automated SMS and instant OTP delivery solutions."
    },
    {
        id:"offer-2",
        img:rcsicon,
        title:"RCS",
        content:"Rich communication, verified sender info, better UX with rich media, boosted engagement, and real-time analytics with read receipts via Google Messages."
    },
    {
        id:"offer-3",
        img:whatsappicon,
        title:"WhatsApp Business API",
        content:"Broadcast promotions, automate support, enhance engagement with chatbots and send automatic payment confirmations."
    },
    {
        id:"offer-4",
        img:emailicon,
        title:"Email",
        content:"Enhance Engagement with Targeted Bulk Emails: High Open Rates, Real-Time Updates, and Personalized Marketing Campaigns."
    },
    {
        id:"offer-5",
        img:voiceicon,
        title:"Voice",
        content:"Our IVR system offers cloud-based solutions to boost customer acquisition, enhance engagement, and improve ROI and efficiency."
    },
]
...
export const chooseConnex=[
    {
        ...
        content:"We optimizes spending with templates and channel selection for cost savings."
    },
    {
        id:"choose-2",
        img:benifiticon,
        title:"Benefit from the Price Advantage: Save up to 24%.",
        content:"Our platform delivers immediate value with up to 24% cost reduction from day one."
    },
    {
        id:"choose-3",
        img:needicon,
        title:"Everything You Need, All in One Place",
        content:"We offer comprehensive messaging solutions SMS, WhatsApp, RCS, IVR, and email."
    },
    {
        id:"choose-4",
        img:featureicon,
        title:"More Features over any other Platform",
        content:"We provide a high-performance platform with advanced UI and API integrations."
    },
    {
        id:"choose-5",
        img:onboarding,
        title:"Start Free Onboarding on Any Channel",
        content:"Join us for free onboarding, plus free credits and up to 9% extra savings."
    },
    {
        id:"choose-6",
        img:supporticon,
        title:"Support You Can Count On: Always Here, 24/7.",
        content:"We trust our dedicated employees to provide exceptional enterprise solutions."
    },
